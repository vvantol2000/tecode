						...
						<div className="col-3 col-sm-6 col-lg-9">
							<div className="header-top-first clearfix">
								...
								<ul className="list-inline hidden-md-down">
									...
									<li className="list-inline-item"><i className="fa fa-phone pr-1 pl-2"></i>+00 123
										123 123
									</li>
									<li className="list-inline-item"><i
										className="fa fa-envelope-o pr-1 pl-2"></i> example@your_domain.com
									</li>
								</ul>
							</div>
						</div>
							...
							<div id="header-top-second" className="clearfix">
								...
								<div className="header-top-dropdown text-right">
									<div className="btn-group">
										<a href="page-signup.html" className="btn btn-default btn-sm"><i
											className="fa fa-user pr-2"></i> Sign Up</a>
									</div>
									<div className="btn-group">
										<button id="header-top-drop-2" type="button"
										        className="btn dropdown-toggle btn-default btn-sm dropdown-toggle--no-caret"
										        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
											className="fa fa-lock pr-2"></i> Login
										</button>
